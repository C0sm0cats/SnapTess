            ...
            if (w) {
                ...
                card._delegate = {index, studio: this, getDragActor: () => {
                    ...
                    handleDragOver: source => {
                        ...
                        if (!card._dropPreview && source.index !== index) {
                            for (const child of content.get_children()) child.opacity = 35;
                            ...
                            card._dropPreview.add_child(new St.Label({text: sourceApp?.get_name() ?? 'Window'}));
