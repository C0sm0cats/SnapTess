    ...
    render() {
        ...
        rects.forEach((rect, index) => {
            ...
            if (w) {
                ...
                const compact = rect.width < 170 || rect.height < 125;
                ...
                if (this.showPreviews && actor && !minimal) {
                    ...
                    clone.set_size(Math.max(48, Math.min(rect.width - 30, compact ? 110 : 170)), compact ? 45 : 70);
                ...
                if (w === global.display.focus_window && !minimal)
